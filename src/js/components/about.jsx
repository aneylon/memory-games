...
const About = () => (
  <div className="w3-display-container game-container">
    <div className="w3-display-middle w3-card-2 w3-white">
      ...
      <p>
        These games are similar to some of the ones that are part of that study.
      </p>
      <p>
        You can find the code for this project on <a href="https://github.com/aneylon/memory-games">github</a>.
      </p>
    </div>
  </div>
)
